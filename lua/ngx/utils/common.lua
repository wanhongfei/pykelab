...
function _M.get_param(self, param_name)
...
function _M.set_param(self, param_name, param_value)
...
function _M.set_post_param(self, param_name, param_value)
    local method = _M:get_req_method()
    if method == 'POST' then
...
function _M.generate_req_id(self)
...
-- 获取请求方法
function _M.get_req_method(self)
    return ngx.var.request_method
end

-- 获取请求uri和?xx=yy参数
function _M.get_req_uri(self)
